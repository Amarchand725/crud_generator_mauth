...
@section('content')
<input type="hidden" id="page_url" value="{{ route('medical.index') }}">
<section class="content-header">
    <div class="content-header-left">
        <h1>{{ $page_title }}</h1>
    </div>
    <div class="content-header-right">
        <a href="{{ route('medical.create') }}" data-toggle="tooltip" data-placement="left" title="Add New Medical" class="btn btn-primary btn-sm">Add New Medical</a>
    </div>
</section>
