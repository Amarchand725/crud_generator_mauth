...
@section('content')
<input type="hidden" id="page_url" value="{{ route('technology.index') }}">
<section class="content-header">
    <div class="content-header-left">
        <h1>{{ $page_title }}</h1>
    </div>
    <div class="content-header-right">
        <a href="{{ route('technology.create') }}" data-toggle="tooltip" data-placement="left" title="Add New Technology" class="btn btn-primary btn-sm">Add New Technology</a>
    </div>
</section>
